    ...
    <section class="hostel fac">
        <div class="wrapper">
            <div class="content">
                <h3>The Hostel</h3>
                <p>
                    The school provides necessary cots, pillows, mattresses, blankets and linen to the inmates with an attached wardrobe. List of the items, which are required to be sent a long with the children when they come to join the hostel, is given separately. The sanitary arrangements and toilet facilities are of a high order with filtered drinking water supply and hot water for bath throughout the year. The laundry, medical and recreational facilities also available at hostel. The hostel inmates and their parents/guardians are expected to follow and rigidly adhere to the hostel rules and regulation, as given in Annexure‑I. The hostel fee applicable for different class of student is mentioned in the fee structure. The hostel fee will be all inclusive i.e. rent, electricity, laundry, routine medical treatment, meals and breakfast with milk. The meals will be purely vegetarian but wholesome, with special diet on weekly and festive occasions. <br>
                    Presently following number of seats are available in Hostel separately for Boys & Girls :
                    <ol>
                        <li>Junior Boys' Hostel - 64 seats</li>
                        <li>Girls' Hostel - 70 seats</li>
                        <li>Senior Boys’ Hostel - 96 seats</li>
                    </ol>
                    There are five houses in the Hostel, viz
                    <ol>
                        <li>Yamuna House</li>
                        <li>Mahanadi House</li>
                        <li>Kaveri House</li>
                        <li>Godavari House</li>
                        <li>Devi Sheela House</li>
                    </ol>
                </p>
            </div>
