    ...
    <section class="intro wow fadeInUp" data-wow-delay="1.5s">
        <div class="wrapper">
            ...
            <div class="content">
                <img src="<?=base_url('assets/images/')?>about_us.jpg" alt="About GGEA">
                <div class="txt">
                    <p id="showLess">
                    ...
                    <button id="moreBtn" onclick="showFull()">Show more +</button>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="founder wow fadeInUp" data-wow-offset="100">
        <div class="wrapper">
            <div class="founder-img">
                ...
                <p class="fname">Late Shri UK Shandilya</p>
                <small>( Founder Chairman )</small>
            </div>
            <div class="founder-note">
                <h4>A vision committed to the parents by our founder</h4>
                <p>
    ...
    <section class="pmv wow fadeInUp" data-wow-offset="100">
        <div class="wrapper">
            <div class="philo card">
                <div class="sign">
                    <svg enable-background="new 0 0 510.089 510.089" viewBox="0 0 510.089 510.089" xmlns="http://www.w3.org/2000/svg">
    ...
    <section class="quality wow fadeInUp" data-wow-offset="100">
        <div class="wrapper">
            ...
            <div class="qps">
                <div class="qp">
                    <p>
                        <strong>Objective: </strong>To instill in child a regular school going habit.
                    </p>
                    <p>
                        <strong>Methodology: </strong> Monitor daily attendance and updating monthly.
                    </p>
                </div>
                <div class="qp">
                    <p>
                        <strong>Objective: </strong>Meticulous implementation of the planned academic calendar. 
                    </p>
                    <p>
                        <strong>Methodology: </strong> Compare planned syllabus with actual completion status.
                    </p>
                </div>
                <div class="qp">
                    <p>
                        <strong>Objective: </strong>Continuous research and re‑orientation workshop to envisage teaching methodology.
                    </p>
                    <p>
                        <strong>Methodology: </strong>: Organise training / Workshops for teachers. 
                    </p>
                </div>
                <div class="qp">
                    <p>
                        <strong>Objective: </strong> Continuous up gradation of infrastructure and availability of modern amenities for creating good academic environment and atmosphere. 
                    </p>
                    <p>
                        <strong>Methodology: </strong> To compute addition to infrastructure.
                    </p>
                </div>
                <div class="qp">
                    <p>
                        <strong>Objective: </strong>Achieving the Excellency in academy by result oriented approach.
                    </p>
                    <p>
                        <strong>Methodology: </strong>  To calculate the number of students passed.
                    </p>
                </div>
                <div class="qp">
                    <p>
                        <strong>Objective: </strong>Over‑all development of the personality of the student giving emphasis on extra-curricular activities.
                    </p>
                    <p>
                        <strong>Methodology: </strong> conduct different types of events/activities in an academic year.
                    </p>
                </div>
                <div class="qp">
                    <p>
                        <strong>Objective: </strong>To provide highest standard of education by nurturing & cultivating the spirit of creativity and innovation among students.
                    </p>
                    <p>
                        <strong>Methodology: </strong> By initiating technology based education.
                    </p>
                </div>
            </div>
        </div>
