...
<head>
    ...
    <title>Gyan Ganga Educational Academy, Raipur (C.G.) | About</title>
...
<body>
    <div class="logo-bar wow fadeInDown">
        <div class="wrapper">
            <a href="index.html"><img src="assets/images/logo.png" alt="GGR Logo" class="logo"></a>
            <div class="address-bar">
                <div class="top-address">
                    ...
                    <p>Baloda bazar road, near Vidhan Sabha, <br> Nardaha, Raipur (C.G.) - 493111</p>
                </div>
                <div class="top-phone">
                    <img src="assets/images/phone-icon-red.png" alt="Phone">
                    <p>0771-2284716 <br> 0771-2284816</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <nav class="wow fadeInDown" data-wow-delay="0.5s">
        <div class="wrapper">
            <a href="" class="scroll-logo-link"><img src="assets/images/footer-logo.PNG" class="scroll-logo" alt="Gyang Ganga Logo"></a>
            ...
            <ul class="menu">
                ...
                <li class="dropdown sm-hide nowrap">
                    ...
                    <div class="submenu">
                        <a href="admissions.html">Admission Procedure</a>
                        <a href="tc.html">Transfer certificates</a>
                    </div>
                </li>
                <li class="sm-show"><a href="admissions.html">Admissions</a></li>
                <li class="sm-show nowrap"><a href="tc.html">Transfer Certificate</a></li>
    ...
    <div class="subheader" style="background:linear-gradient(to right,rgba(0,0,0,0.85) 40%,rgba(0,0,0,0.3)), url('assets/images/header-news.jpg') no-repeat">
        <div class="wrapper">
    ...
    <section class="all-news">
        <div class="wrapper">
            <div class="news-txt">
                <a href="">1. Some news with a meaningful heading will be shown here.</a><br>
                <small><em>Date uploaded: 02-06-2020</em></small>
            </div>
            <div class="news-txt">
                <a href="">2. Some news with a meaningful heading will be shown here.</a><br>
                <small><em>Date uploaded: 02-06-2020</em></small>
            </div>
            <div class="news-txt">
                <a href="">3. Some news with a meaningful heading will be shown here.</a><br>
                <small><em>Date uploaded: 02-06-2020</em></small>
            </div>
            <div class="news-txt">
                <a href="">4. Some news with a meaningful heading will be shown here.</a><br>
                <small><em>Date uploaded: 02-06-2020</em></small>
            </div>
            <div class="news-txt">
                <a href="">5. Some news with a meaningful heading will be shown here.</a><br>
                <small><em>Date uploaded: 02-06-2020</em></small>
            </div>
        </div>
    </section>
