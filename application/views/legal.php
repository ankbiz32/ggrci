    ...
    <div class="subheader" style="background:linear-gradient(to right,rgba(0,0,0,0.85) 40%,rgba(0,0,0,0.3)), url('<?=base_url()?>assets/images/header-legal.jpg') no-repeat">
        <div class="wrapper">
            <h2 class="subheader-head serif">Legal</h2>
    ...
    <section class="legal">
        <div class="wrapper">
            ...
            <div class="legal-div">
                ...
                <p>The following rules shall be observed strictly:</p>
                <ol>
            ...
            <div class="legal-div">
                ...
                <ol>
                    <li>Without permission of the competent, authority entering in the Hostel Campus is prohibited. It will be treated as an offence.</li>
                    <li>Parents are here by required to follow the timings notified by the Chief Warden to avoid any inconvenience.</li>
                    <li>No leave will be granted in between the term. Parent can plan their Holidays as per the vacation schedule of the Academy.</li>
                    <li> In case of illness, leave will be granted by the Principal: seek prior permission for the same.</li>
                    <li>Student will only be allowed to keep the articles/material, as per the list approved by the competent authority.</li>
                    <li>Keeping Mobile Phone, Cash, jewellery, other valuable items, eatables, electronic equipment, sharp edged material or anything apart from the list provided by the Hostel authority is prohibited. In case any thing is seized from the student he/she will be expelled from the Hostel and further may be from the Academy. School/Hostel authorities will not be responsible for any loss or  theft of any of the items which are not aIIowed to keep in the Hostel.</li>
                    <li>The Hostel facility will only be provided to the student after personal interview. The conduct and behaviour will be closely observed for continuing his/her admission in the Hostel.</li>
                    <li>Using filthy, abusive language, indiscipline, act of gross misconduct, violating the instructions of the warden, arrogant and disorderly behaviour, elope from the Hostels, beating or teasing co‑student, continuous unauthorized absence from the Hostel/Academy and non-payment of fee are certain causes under which the student will be immediately expelled from the Hostel and / or from the Academy too.</li>
                    <li> If any student is receiving medication, the chief warden/medical officer must be informed. No Hosteller will be admitted without the approval / prior check‑up of the medical officer.</li>
                    <li>Smoking/consumption of alcohol/liquor/drugs/tobacco in any form is strictly prohibited. Any student found under its influence will be expelled from the Hostel/Academy.</li>
                </ol>
            </div>
            <div class="legal-div">
