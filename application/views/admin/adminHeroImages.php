...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark"><i class="fa fa-film"></i>&nbsp;&nbsp;Slider Images</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
              <div class="card-header row">
                <h2 class="card-title col">List of Slider Images:</h2>
               ...
               <?php foreach($images as $image){?>
                <div class="col-md-3 col-sm-4 col-xs-6 mb-5">
                    ...
                    <div class="row mt-2 ml-4">
                        <div class="col ml-3">
                            <a href="<?=base_url('Delete/heroImg/'.$image->id)?>" onclick="confirmation(event)" class="btn del-btn btn-danger mr-2 mb-1" title="Delete Image"><i class="fa fa-trash-alt"></i></a>
                    ...
                    <div class="modal fade" id="editImg<?=$image->id?>">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-body">
                                <form role="form" method="post" action="<?php echo base_url();?>Edit/heroImage/<?=$image->id?>" enctype="multipart/form-data">
...
<!-- new Image modal -->
    <div class="modal fade" id="addImage">
      <div class="modal-dialog">
          ...
          <div class="modal-body">
              <form role="form" method="post" action="<?php echo base_url();?>Add/heroImage" enctype="multipart/form-data">
                <div class="form-group">
