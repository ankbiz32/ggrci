...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark"><i class="fa fa-comment-alt"></i>&nbsp;&nbsp;Testimonials</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
              <div class="card-header row">
                <h2 class="card-title col">List of Testimonials:</h2>
                <button class="btn btn-primary ml-auto" data-toggle="modal" data-target="#add">+ Add new testimonial</button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <?php foreach ($data as $d){?>
                      <tr>
                        ...
                        <td><?=$d->rating?></td>
                        <td>
                          <a href="<?=base_url('Delete/Testimonial/'.$d->id)?>" onclick="confirmation(event)" class="btn del-btn btn-danger mb-1" title="Delete Feedback"><i class="fa fa-trash-alt"></i></a>
                        ...
                        <div class="modal fade" id="edit<?=$d->id?>">
                            <div class="modal-dialog modal-lg">
                                ...
                                <div class="modal-header">
                                    <h4 class="modal-title"> <i class="fa fa-edit"></i> &nbsp; Edit testimonial:</h4>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <form role="form" method="post" action="<?php echo base_url();?>Edit/Testimonial/<?=$d->id?>" enctype="multipart/form-data">
                                      <div class="col">
                                        ...
                                        <div class="form-group">
                                            <label for="content" class="m-0">Testimonial:</label>
 ...
 <!-- Add modal -->
  <div class="modal fade" id="add">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-body">
            <form role="form" method="post" action="<?=base_url();?>Add/Testimonial">
              <div class="col">
                <div class="form-group px-0 col-md-4 col-sm-12">
                    <label for="rating" class="m-0">Rating (out of 5 stars): *</label>
                    <select name="rating" id="rating" class="form-control m-0">
