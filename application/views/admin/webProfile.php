...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-3">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><i class="fa fa-globe"></i>&nbsp; GIS web profile:</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=base_url('Admin')?>">Home</a></li>
              <li class="breadcrumb-item active">GIS web profile</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container fluid -->
            ...
            <div class="card">
                <div class="card-body d-flex flex-wrap">
                    <div class="col">
                      ...
                      <span class="p-2 bg-light"><?=$profile->phone1; ?></span> <br><br>
                      <label class="label pl-2">Contact no.: <span class="text-muted"> &nbsp;(Alt)</span></label><br>
                      <span class="p-2 bg-light"><?=$profile->phone2; ?></span> <br><br>
                      <!-- <label class="label pl-2">Whatsapp no.:</label><br>
                      <span class="p-2 bg-light"><?=$profile->whatsapp_no; ?></span> <br><br> -->
                      <label class="label pl-2">Address (line 1):</label><br>
                      <span class="p-2 bg-light"><?=$profile->address_line1; ?></span><br><br>
                      <label class="label pl-2">Address (line 2):</label><br>
                      <span class="p-2 bg-light"><?=$profile->address_line2; ?></span><br><br>
                      <label class="label pl-2">Address (line 3):</label><br>
                    ...
                    <div class="col">
                      ...
                      <span class="p-2 bg-light"><?=$profile->instalink; ?></span><br><br>
                      <label class="label pl-2">Twitter link:</label><br>
                      <span class="p-2 bg-light"><?=$profile->twitterlink; ?></span><br><br>
                      <label class="label pl-2">Youtube link:</label><br>
                      <span class="p-2 bg-light"><?=$profile->youtubelink; ?></span>
                    </div>
                </div>
                <!-- /.card-body -->
