...
<?php if(empty($n)){?>
    <p class="wrapper" style="padding:10rem 0; font-style:italic; font-weight:600; font-size:2rem; color:#555;">News not found ! <br> <br><a onclick="window.history.back()" style="cursor:pointer; padding:0.8rem 1.2rem; background-color:rgb(66, 133, 244);  color:white; font-size:1.6rem;">← &nbsp;Go back</a></p>
<?php } else{?>
